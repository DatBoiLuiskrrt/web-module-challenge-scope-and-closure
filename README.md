...
1. In your own words, define closure (1-2 sentences).
   A closure happens when an inner function reaches into an outer function to grab a value defined in the outer function. It is code that is created elsewhere that we can use later.
